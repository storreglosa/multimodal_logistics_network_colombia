# multimodal_logistics_network_colombia guide installation
...
```bash
conda env create --file environment.yml --name multimodal_logistics_network_colombia
conda activate multimodal_logistics_network_colombia
```
...
activate multimodal_logistics_network_colombia
```
...
To move beyond notebook prototyping, all reusable code should go into the `multimodal_logistics_network_colombia/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `multimodal_logistics_network_colombia` folder and use the modules inside your notebooks :
...
```python
from multimodal_logistics_network_colombia.utils.paths import data_dir
data_dir()
```
